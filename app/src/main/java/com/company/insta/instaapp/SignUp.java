...
public class SignUp extends AppCompatActivity {
    ...
    {
        password_et.setError("Password characters dont match");
        password_et.requestFocus();
        mProgressDailog.dismiss();
        return;
    }

        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLS.sign_up_api, new Response.Listener<String>() {
            @Override
